...
const (
	...
	fohMinDistance    = 15 // TDL: Upped from 5 to 20, sometimes to far for Conviction so can do 15 too
	fohMaxDistance    = 20 // TDL :Upped from 20 to 25,sometimes to far for Conviction so could also leave this at 20
)
